...
namespace cppu {
  ...
  protected:
    ...
    struct CallbackMethod : public Callback {
      ...
      T& obj;
      // Fun is the type of memeber function pointer of class T!
      // method is a memeber function pointer of class T.
      Fun method;
      // Here, we use memeber function pointer for calling the function we want.
      // this is the constructor of struct CallbackMethod!
